...
@in_testdir
def test_flavor_openshift_415_openstack():
    run_provision(
        "flavor_openshift_415_openstack.inp.yaml",
        "flavor_openshift_415_openstack.kube.yaml",
        "flavor_openshift_415_openstack_tar",
        None,
        "flavor_openshift_415_openstack.apic.txt",
        overrides={"flavor": "openshift-4.15-openstack"}
    )
...
@in_testdir
def test_flavor_openshift_417_openstack():
    run_provision(
        "flavor_openshift_417_openstack.inp.yaml",
        "flavor_openshift_417_openstack.kube.yaml",
        "flavor_openshift_417_openstack_tar",
        None,
        "flavor_openshift_417_openstack.apic.txt",
        overrides={"flavor": "openshift-4.17-openstack"}
    )


@in_testdir
def test_flavor_openshift_418_openstack():
    run_provision(
        "flavor_openshift_418_openstack.inp.yaml",
        "flavor_openshift_418_openstack.kube.yaml",
        "flavor_openshift_418_openstack_tar",
        None,
        "flavor_openshift_418_openstack.apic.txt",
        overrides={"flavor": "openshift-4.18-openstack"}
    )


@in_testdir
def test_flavor_openshift_419_openstack():
    run_provision(
        "flavor_openshift_419_openstack.inp.yaml",
        "flavor_openshift_419_openstack.kube.yaml",
        "flavor_openshift_419_openstack_tar",
        None,
        "flavor_openshift_419_openstack.apic.txt",
        overrides={"flavor": "openshift-4.19-openstack"}
    )
...
@in_testdir
def test_flavor_openshift_421_openstack():
    run_provision(
        "flavor_openshift_421_openstack.inp.yaml",
        "flavor_openshift_421_openstack.kube.yaml",
        "flavor_openshift_421_openstack_tar",
        None,
        "flavor_openshift_421_openstack.apic.txt",
        overrides={"flavor": "openshift-4.21-openstack"}
    )
...
@in_testdir
def test_flv_openshift_414_esx():
    run_provision(
        "flavor_openshift_414_esx.inp.yaml",
        "flavor_openshift_414_esx.kube.yaml",
        "flavor_openshift_414_esx_tar",
        None,
        "flavor_openshift_414_esx.apic.txt",
        overrides={"flavor": "openshift-4.14-esx"}
    )
...
def test_flavor_openshift_415_esx():
    run_provision(
        ...
        "flavor_openshift_415_esx.kube.yaml",
        "flavor_openshift_415_esx_tar",
        None,
        "flavor_openshift_415_esx.apic.txt",
        overrides={"flavor": "openshift-4.15-esx"}
    )
...
@in_testdir
def test_flavor_openshift_417_esx():
    run_provision(
        "flavor_openshift_417_esx.inp.yaml",
        "flavor_openshift_417_esx.kube.yaml",
        "flavor_openshift_417_esx_tar",
        None,
        "flavor_openshift_417_esx.apic.txt",
        overrides={"flavor": "openshift-4.17-esx"}
    )


@in_testdir
def test_flavor_openshift_418_esx():
    run_provision(
        "flavor_openshift_418_esx.inp.yaml",
        "flavor_openshift_418_esx.kube.yaml",
        "flavor_openshift_418_esx_tar",
        None,
        "flavor_openshift_418_esx.apic.txt",
        overrides={"flavor": "openshift-4.18-esx"}
    )


@in_testdir
def test_flavor_openshift_419_esx():
    run_provision(
        "flavor_openshift_419_esx.inp.yaml",
        "flavor_openshift_419_esx.kube.yaml",
        "flavor_openshift_419_esx_tar",
        None,
        "flavor_openshift_419_esx.apic.txt",
        overrides={"flavor": "openshift-4.19-esx"}
    )
...
@in_testdir
def test_flavor_openshift_421_esx():
    run_provision(
        "flavor_openshift_421_esx.inp.yaml",
        "flavor_openshift_421_esx.kube.yaml",
        "flavor_openshift_421_esx_tar",
        None,
...
@in_testdir
def test_flavor_openshift_421_agent_based_esx():
    run_provision(
        "flavor_openshift_421_agent_based_esx.inp.yaml",
        "flavor_openshift_421_agent_based_esx.kube.yaml",
        "flavor_openshift_421_agent_based_esx_tar",
        None,
        "flavor_openshift_421_agent_based_esx.apic.txt",
        overrides={"flavor": "openshift-4.21-agent-based-esx"}
    )
...
def test_flavor_openshift_419_agent_based_esx():
    run_provision(
        ...
        "flavor_openshift_419_agent_based_esx.kube.yaml",
        "flavor_openshift_419_agent_based_esx_tar",
        None,
...
@in_testdir
def test_flavor_openshift_418_agent_based_esx():
    run_provision(
        "flavor_openshift_418_agent_based_esx.inp.yaml",
        "flavor_openshift_418_agent_based_esx.kube.yaml",
        "flavor_openshift_418_agent_based_esx_tar",
        None,
        "flavor_openshift_418_agent_based_esx.apic.txt",
        overrides={"flavor": "openshift-4.18-agent-based-esx"}
    )


@in_testdir
def test_flavor_openshift_417_agent_based_esx():
    run_provision(
        "flavor_openshift_417_agent_based_esx.inp.yaml",
        "flavor_openshift_417_agent_based_esx.kube.yaml",
        "flavor_openshift_417_agent_based_esx_tar",
        None,
        "flavor_openshift_417_agent_based_esx.apic.txt",
        overrides={"flavor": "openshift-4.17-agent-based-esx"}
    )
...
def test_flavor_openshift_414_agent_based_esx():
    run_provision(
        ...
        "flavor_openshift_414_agent_based_esx.kube.yaml",
        "flavor_openshift_414_agent_based_esx_tar",
        None,
        "flavor_openshift_414_agent_based_esx.apic.txt",
        overrides={"flavor": "openshift-4.14-agent-based-esx"}
    )
...
@in_testdir
def test_flv_openshift_414_baremetal():
    run_provision(
        "flavor_openshift_414_baremetal.inp.yaml",
        "flavor_openshift_414_baremetal.kube.yaml",
        "flavor_openshift_414_baremetal_tar",
        None,
        "flavor_openshift_414_baremetal.apic.txt",
        overrides={"flavor": "openshift-4.14-baremetal"}
    )
...
def test_flavor_openshift_415_baremetal():
    run_provision(
        ...
        "flavor_openshift_415_baremetal.kube.yaml",
        "flavor_openshift_415_baremetal_tar",
        None,
...
@in_testdir
def test_flavor_openshift_417_baremetal():
    run_provision(
        "flavor_openshift_417_baremetal.inp.yaml",
        "flavor_openshift_417_baremetal.kube.yaml",
        "flavor_openshift_417_baremetal_tar",
        None,
        "flavor_openshift_417_baremetal.apic.txt",
        overrides={"flavor": "openshift-4.17-baremetal"}
    )


@in_testdir
def test_flavor_openshift_418_baremetal():
    run_provision(
        "flavor_openshift_418_baremetal.inp.yaml",
        "flavor_openshift_418_baremetal.kube.yaml",
        "flavor_openshift_418_baremetal_tar",
        None,
        "flavor_openshift_418_baremetal.apic.txt",
        overrides={"flavor": "openshift-4.18-baremetal"}
    )


@in_testdir
def test_flavor_openshift_419_baremetal():
    run_provision(
        "flavor_openshift_419_baremetal.inp.yaml",
        "flavor_openshift_419_baremetal.kube.yaml",
        "flavor_openshift_419_baremetal_tar",
        None,
        "flavor_openshift_419_baremetal.apic.txt",
        overrides={"flavor": "openshift-4.19-baremetal"}
    )
...
@in_testdir
def test_flavor_openshift_421_baremetal():
    run_provision(
        "flavor_openshift_421_baremetal.inp.yaml",
        "flavor_openshift_421_baremetal.kube.yaml",
        "flavor_openshift_421_baremetal_tar",
        None,
...
@in_testdir
def test_flavor_openshift_421_agent_based_baremetal():
    run_provision(
        "flavor_openshift_421_agent_based_baremetal.inp.yaml",
        "flavor_openshift_421_agent_based_baremetal.kube.yaml",
        "flavor_openshift_421_agent_based_baremetal_tar",
        None,
        "flavor_openshift_421_agent_based_baremetal.apic.txt",
        overrides={"flavor": "openshift-4.21-agent-based-baremetal"}
    )
...
def test_flavor_openshift_419_agent_based_baremetal():
    run_provision(
        "flavor_openshift_419_agent_based_baremetal.inp.yaml",
        "flavor_openshift_419_agent_based_baremetal.kube.yaml",
        "flavor_openshift_419_agent_based_baremetal_tar",
        None,
        "flavor_openshift_419_agent_based_baremetal.apic.txt",
        overrides={"flavor": "openshift-4.19-agent-based-baremetal"}
    )


@in_testdir
def test_flavor_openshift_418_agent_based_baremetal():
    run_provision(
        "flavor_openshift_418_agent_based_baremetal.inp.yaml",
        "flavor_openshift_418_agent_based_baremetal.kube.yaml",
        "flavor_openshift_418_agent_based_baremetal_tar",
        None,
        "flavor_openshift_418_agent_based_baremetal.apic.txt",
        overrides={"flavor": "openshift-4.18-agent-based-baremetal"}
    )


@in_testdir
def test_flavor_openshift_417_agent_based_baremetal():
    run_provision(
        "flavor_openshift_417_agent_based_baremetal.inp.yaml",
        "flavor_openshift_417_agent_based_baremetal.kube.yaml",
        "flavor_openshift_417_agent_based_baremetal_tar",
        None,
        "flavor_openshift_417_agent_based_baremetal.apic.txt",
        overrides={"flavor": "openshift-4.17-agent-based-baremetal"}
    )
...
@in_testdir
def test_flavor_openshift_414_agent_based_baremetal():
    run_provision(
        "flavor_openshift_414_agent_based_baremetal.inp.yaml",
        "flavor_openshift_414_agent_based_baremetal.kube.yaml",
        "flavor_openshift_414_agent_based_baremetal_tar",
        None,
        "flavor_openshift_414_agent_based_baremetal.apic.txt",
        overrides={"flavor": "openshift-4.14-agent-based-baremetal"}
    )
...
@in_testdir
def test_flavor_RKE2_kubernetes_1_27_base():
    run_provision(
        "flavor_RKE2_kubernetes_1_27.inp.yaml",
        "flavor_RKE2_kubernetes_1_27.kube.yaml",
        None,
        None,
        "flavor_RKE2_kubernetes_1_27.apic.txt",
        overrides={"flavor": "RKE2-kubernetes-1.27"}
    )


@in_testdir
def test_flavor_RKE2_kubernetes_1_28_base():
    run_provision(
        "flavor_RKE2_kubernetes_1_28.inp.yaml",
        "flavor_RKE2_kubernetes_1_28.kube.yaml",
        None,
        None,
        "flavor_RKE2_kubernetes_1_28.apic.txt",
        overrides={"flavor": "RKE2-kubernetes-1.28"}
    )


@in_testdir
def test_flavor_RKE2_kubernetes_1_29_base():
    run_provision(
        "flavor_RKE2_kubernetes_1_29.inp.yaml",
        "flavor_RKE2_kubernetes_1_29.kube.yaml",
        None,
        None,
        "flavor_RKE2_kubernetes_1_29.apic.txt",
        overrides={"flavor": "RKE2-kubernetes-1.29"}
    )
...
@in_testdir
def test_flavor_RKE2_kubernetes_1_33_base():
    run_provision(
        "flavor_RKE2_kubernetes_1_33.inp.yaml",
        "flavor_RKE2_kubernetes_1_33.kube.yaml",
        None,
        None,
        "flavor_RKE2_kubernetes_1_33.apic.txt",
        overrides={"flavor": "RKE2-kubernetes-1.33"}
    )


@in_testdir
def test_flavor_RKE2_kubernetes_1_34_base():
    run_provision(
        "flavor_RKE2_kubernetes_1_34.inp.yaml",
        "flavor_RKE2_kubernetes_1_34.kube.yaml",
        None,
        None,
        "flavor_RKE2_kubernetes_1_34.apic.txt",
        overrides={"flavor": "RKE2-kubernetes-1.34"}
    )
...
@in_testdir
def test_flavor_RKE_1_4_16_base():
    run_provision(
        "flavor_RKE_1_4_16.inp.yaml",
        "flavor_RKE_1_4_16.rke.yaml",
        None,
        None,
        "flavor_RKE_1_4_16.apic.txt",
        overrides={"flavor": "RKE-1.4.16"}
    )


@in_testdir
def test_flavor_RKE_1_5_6_base():
    run_provision(
        "flavor_RKE_1_5_6.inp.yaml",
        "flavor_RKE_1_5_6.rke.yaml",
        None,
        None,
        "flavor_RKE_1_5_6.apic.txt",
        overrides={"flavor": "RKE-1.5.6"}
    )
...
@in_testdir
def test_flavor_RKE_1_5_14_base():
    run_provision(
        "flavor_RKE_1_5_14.inp.yaml",
        "flavor_RKE_1_5_14.rke.yaml",
        None,
        None,
        "flavor_RKE_1_5_14.apic.txt",
        overrides={"flavor": "RKE-1.5.14"}
    )


@in_testdir
def test_flavor_RKE_1_6_3_base():
    run_provision(
        "flavor_RKE_1_6_3.inp.yaml",
        "flavor_RKE_1_6_3.rke.yaml",
        None,
        None,
        "flavor_RKE_1_6_3.apic.txt",
        overrides={"flavor": "RKE-1.6.3"}
    )


@in_testdir
def test_flavor_RKE_1_6_5_base():
    run_provision(
        "flavor_RKE_1_6_5.inp.yaml",
        "flavor_RKE_1_6_5.rke.yaml",
        None,
        None,
        "flavor_RKE_1_6_5.apic.txt",
        overrides={"flavor": "RKE-1.6.5"}
    )


@in_testdir
def test_flavor_RKE_1_7_1_base():
    run_provision(
        "flavor_RKE_1_7_1.inp.yaml",
        "flavor_RKE_1_7_1.rke.yaml",
        None,
        None,
        "flavor_RKE_1_7_1.apic.txt",
        overrides={"flavor": "RKE-1.7.1"}
    )


@in_testdir
def test_flavor_RKE_1_6_6_base():
    run_provision(
        "flavor_RKE_1_6_6.inp.yaml",
        "flavor_RKE_1_6_6.rke.yaml",
        None,
        None,
        "flavor_RKE_1_6_6.apic.txt",
        overrides={"flavor": "RKE-1.6.6"}
    )


@in_testdir
def test_flavor_RKE_1_7_2_base():
    run_provision(
        "flavor_RKE_1_7_2.inp.yaml",
        "flavor_RKE_1_7_2.rke.yaml",
        None,
        None,
        "flavor_RKE_1_7_2.apic.txt",
        overrides={"flavor": "RKE-1.7.2"}
    )


@in_testdir
def test_flavor_RKE_1_6_10_base():
    run_provision(
        "flavor_RKE_1_6_10.inp.yaml",
        "flavor_RKE_1_6_10.rke.yaml",
        None,
        None,
        "flavor_RKE_1_6_10.apic.txt",
        overrides={"flavor": "RKE-1.6.10"}
    )


@in_testdir
def test_flavor_RKE_1_7_7_base():
    run_provision(
        "flavor_RKE_1_7_7.inp.yaml",
        "flavor_RKE_1_7_7.rke.yaml",
        None,
        None,
        "flavor_RKE_1_7_7.apic.txt",
        overrides={"flavor": "RKE-1.7.7"}
    )


@in_testdir
def test_flavor_RKE_1_8_3_base():
    run_provision(
        "flavor_RKE_1_8_3.inp.yaml",
        "flavor_RKE_1_8_3.rke.yaml",
        None,
        None,
        "flavor_RKE_1_8_3.apic.txt",
        overrides={"flavor": "RKE-1.8.3"}
    )
